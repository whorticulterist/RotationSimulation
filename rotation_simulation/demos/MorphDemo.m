...
if nargin < 1 || isempty(textureon)
    textureon = 1;  % turn texture mapping on (1) or off (0) -- only sphere and face has textures
end
textureon %#ok<NOPRT>
...
objs = [ LoadOBJFile([basepath 'checkerDisk.obj']) LoadOBJFile([basepath 'checkerDisk.obj']) ];
